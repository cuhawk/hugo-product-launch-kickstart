...
r
In case you would like to `git clone` this repository to your local machine, please take care to check out the `themes/hugo-product-launch`-submodule as well e.g. via running fix this
